...
class WatchController extends Controller
{
    ...
    {
        return view('dashboard.watch.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('watch')->with('success', 'Data berhasil disimpan');
    }
    ...
    {
        return view('dashboard.watch.view',[
            'watch' => File::find($id)
        ]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('watch')->with('success', 'Data edited');
    }
    ...
    {
        File::destroy($id);
        return redirect('watch')->with('success', 'Data deleted');
    }
}
