...
<a href="listen/create" class="btn bg-success text-white">
 Insert Audio
</a>
  ...
  <table class="table table-striped table-sm">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="/listen/{{ $listens->file_id }}" class="badge bg-info">
            <span data-feather="eye"></span>
          </a>
          <a href="/listen/{{ $listens->file_id }}/edit" class="badge bg-warning">
            <span data-feather="edit"></span>
          </a>
          <form  action="/listen/{{ $listens->file_id }}" method="post" class="d-inline">
            @method('delete')
            @csrf
